...
- Fitxer: `assets/images/gloria-hero-provisional.jpg`
- Estat: **PROVISIONAL**.
- Ús actual: construir la primera versió funcional de la landing i preparar una demo per ensenyar-la a Glòria Solsona Martí.
- Aquesta fotografia s'haurà de substituir per la fotografia definitiva que faciliti o aprovi la clienta.
